...
- run_id: cmnoqbq1d001uhc0sba28qhtn
...
SDF:
Create an Integration Record on the NetSuite Account:
-Enable Token-based Authentication, Checked TBA: issuetoken Endpoint and User Credentials
- Capture Client ID
Generate a private and a public certificate (x509) and create a "OAuth 2.0 Client Credentials Setup" M2M token
...
Generate a private and a public certificate (x509) and create a "OAuth 2.0 Client Credentials Setup" M2M token
- Capture Certificate ID
Deploy the NS-GM Restlet Script (https://github.com/Project-X-Innovation/ns-gm/blob/main/ns_gm_restlet.js) on the account 
- Capture Restlet URL

NATIVE NS Repo
- Create a repo on Project X Innovation Github
- Initialize an SDF project
- Authenticate with SDF Credentials
- Run "import_all.js" Script to populate the initial state of the FileCabinet
